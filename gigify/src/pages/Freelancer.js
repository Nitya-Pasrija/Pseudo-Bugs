...
export default function Freelancer() {
  ...
  <div class="mt-5 text-center">
        <h1 className='m-20'>Register your company, Gigify your World</h1>
      </div>
    <div
      class="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-3500 g-6"
    >

      <div
        class="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-6/12 md:w-9/12 mb-4 md:mb-0"
      >
        <img
      ...
      <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
        <form>
          ...
          <div class="flex justify-between items-center mb-4">
            ...
            <NavLink to="/" class="text-gray-800">
            Forgot password?
            </NavLink>
          </div>
